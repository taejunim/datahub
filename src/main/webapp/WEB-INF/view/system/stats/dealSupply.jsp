    ...
    <div class="row">
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="item-group col-sm-12 col-xs-12">
                            <input type="hidden" id="insttCdLike" value="BCNC_SUPPLY"/>
        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                ...
                <div class="box-body" >
                    <table id="datatabless" class="table table-bordered table-striped" style="width:100%; table-layout:fixed;"></table>
